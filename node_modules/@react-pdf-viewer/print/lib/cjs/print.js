...
var PrintButton = function (_a) {
    ...
    return (React.createElement(core.Tooltip, { position: core.Position.BottomCenter, target: React.createElement(core.Button, { onClick: onClick },
            React.createElement(PrintIcon, null)), content: function () { return label; }, offset: TOOLTIP_OFFSET }));
};
...
var Print = function (_a) {
    ...
    var defaultChildern = function (props) { return React.createElement(PrintButton, { onClick: props.onClick }); };
...
var PrintProgress = function (_a) {
    ...
    return (React.createElement("div", { className: 'rpv-print-progress' },
        React.createElement("div", { className: 'rpv-print-progress-inner' },
            React.createElement("div", { className: 'rpv-print-progress-message' }, l10n && l10n.print ? l10n.print.preparingDocument : 'Preparing document ...'),
            React.createElement("div", { className: 'rpv-print-progress-bar' },
                React.createElement(core.ProgressBar, { progress: progress })),
            React.createElement(core.PrimaryButton, { onClick: onCancel }, l10n && l10n.print ? l10n.print.cancel : 'Cancel'))));
};
...
var PageThumbnail = function (_a) {
    ...
    return (!src
        ...
        : (React.createElement("div", { className: 'rpv-print-page-thumbnail', style: {
...
var PageThumbnailContainer = function (_a) {
    ...
    return (!page
        ? React.createElement(core.Spinner, null)
        : (React.createElement(PageThumbnail, { page: page, pageHeight: isVertical ? height : width, pageWidth: isVertical ? width : height, rotation: rotationNumber, onLoad: onLoad })));
};
...
var PrintZone = function (_a) {
    ...
    return (reactDom.createPortal((React.createElement(React.Fragment, null,
        React.createElement("div", { className: 'rpv-print-zone' }, Array(numPages).fill(0).map(function (_, index) {
...
var printPlugin = function () {
    ...
    var PrintDecorator = function (props) { return (React.createElement(Print, __assign({}, props, { store: store }))); };
    var PrintButtonDecorator = function () { return (React.createElement(PrintDecorator, null, function (props) { return React.createElement(PrintButton, __assign({}, props)); })); };
    var renderViewer = function (props) {
        var slot = props.slot;
        var updateSlot = {
            children: (React.createElement(React.Fragment, null,
                React.createElement(PrintContainer, { doc: props.doc, pageHeight: props.pageHeight, pageWidth: props.pageWidth, rotation: props.rotation, store: store }),
                slot.children))
        };
