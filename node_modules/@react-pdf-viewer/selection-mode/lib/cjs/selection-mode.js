...
var SwitchSelectionModeDecorator = function (_a) {
    ...
    var label = '';
    var icon = React.createElement(TextSelectionIcon, null);
    switch (mode) {
...
var SwitchSelectionMode = function (_a) {
    ...
    var defaultChildren = function (props) { return (React.createElement(SwitchSelectionModeButton, { isSelected: isSelected, mode: props.mode, onClick: props.onClick })); };
...
var SwitchSelectionModeMenuItem = function (_a) {
    var isSelected = _a.isSelected, mode = _a.mode, onClick = _a.onClick;
    return (React.createElement(SwitchSelectionModeDecorator, { mode: mode, onClick: onClick }, function (props) { return (React.createElement(core.MenuItem, { checked: isSelected, icon: props.icon, onClick: props.onClick }, props.label)); }));
};
...
var selectionModePlugin = function (props) {
    ...
    var SwitchSelectionModeDecorator = function (props) { return (React.createElement(SwitchSelectionMode, __assign({}, props, { store: store }))); };
    var SwitchSelectionModeButtonDecorator = function (props) { return (React.createElement(SwitchSelectionModeDecorator, { mode: props.mode }, function (p) { return (React.createElement(SwitchSelectionModeButton, { isSelected: p.isSelected, mode: p.mode, onClick: function () { p.onClick(); } })); })); };
    var SwitchSelectionModeMenuItemDecorator = function (props) { return (React.createElement(SwitchSelectionModeDecorator, { mode: props.mode }, function (p) { return (React.createElement(SwitchSelectionModeMenuItem, { isSelected: p.isSelected, mode: p.mode, onClick: function () { p.onClick(); props.onClick(); } })); })); };
